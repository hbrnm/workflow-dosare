...
describe("buildAtelierFunnel", () => {
  it("computes create → programare → alerte rates", () => {
    const claims = [
      { id: "1", dataProgramare: "2026-08-01T09:00:00", blocat: false, status: "air", dataSchimbareStatus: new Date().toISOString(), termenAlertaZile: 99 },
      { id: "2", dataProgramare: null, blocat: true, status: "air", dataSchimbareStatus: new Date().toISOString(), termenAlertaZile: 99 },
      { id: "3", dataProgramare: "2026-08-02T10:00:00", blocat: false, status: "air", dataSchimbareStatus: new Date().toISOString(), termenAlertaZile: 99 },
    ];
