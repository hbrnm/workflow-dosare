...
export function emptyClaim(status = "deschidere", defaultInsurer = "Omniasig VIG") {
  return {
    ...
    financiar: { tvaProc: 21, pieseFacturateFaraTva: 0, costManoperaInterna: 0, costManoperaTinichigerieService: 0, costManoperaVopsitorieService: 0, costuriExterne: 0, costMasinaSchimb: 0, numarFactura: "", dataFactura: null, audatex: emptyAudatexDevizTotals() },
