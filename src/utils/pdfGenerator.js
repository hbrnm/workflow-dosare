...
export async function generateazaCerereDespagubireAsirom(claim, options = null) {
  const { fillCerereAsiromOfficial } = await import("./cerereOfficialFill");
  return fillCerereAsiromOfficial(claim, options);
}

export async function generateazaCerereDespagubireGroupama(claim, options = null) {
  const { fillCerereGroupamaOfficial } = await import("./cerereOfficialFill");
  return fillCerereGroupamaOfficial(claim, options);
}

export async function generateazaCerereDespagubireGrawe(claim, options = null) {
  const { fillCerereGraweOfficial } = await import("./cerereOfficialFill");
  return fillCerereGraweOfficial(claim, options);
}
