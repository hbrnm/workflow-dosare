...
export async function generateazaContractInchiriere(claim) {
  ...
  const drawText = (text, spacing = 3.5) => {
  ...
  doc.setFont(undefined, "normal");
  drawText(sd("Obiectul contractului îl constituie închirierea autoturismului marca " + sd(claim.masinaSchimbModel || "....................................................") + ", nr. Inmatriculare " + sd(claim.masinaSchimbNumar || "..............................................") + " (pentru clientul cu auto avariat marca " + sd(claim.marcaModel || ".....") + " nr. " + sd(claim.numarInmatriculare || ".....") + ")."));

  doc.setFont(undefined, "bold");
  drawText(sd("Art. 3 - TERMENUL :"));
  doc.setFont(undefined, "normal");
  drawText(sd("Închirierea se face pe o perioada determinata/calculata, conform ore manopera deviz reparatie intocmit in baza nota constatare/reconstatatre eliberate de asigurator, dupa caz " + (claim.zileChirieAudatex || "............") + " zile, începând cu data de " + fmtDate(claim.dataDariiLaSchimb || claim.dataProgramare || new Date()) + ", ora ......"));
  ...
  drawText(sd(cesiunea), 4);
  
  doc.setFont(undefined, "bold");
  drawText(sd("Art. 9 – ÎNCETAREA CONTRACTULUI :"));
  doc.setFont(undefined, "normal");
  ...
  drawText(sd(incetarea), 4);

  doc.setFont(undefined, "bold");
  drawText(sd("Art. 10 – FORȚA MAJORĂ :"));
  doc.setFont(undefined, "normal");
  ...
  drawText(sd(fortaM), 4);

  doc.setFont(undefined, "bold");
  drawText(sd("Art. 11 – NOTIFICĂRI, LITIGII, CLAUZE FINALE :"));
  doc.setFont(undefined, "normal");
